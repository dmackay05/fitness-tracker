...
var DS_SESSIONS={
  mon:{title:'Upper Body A',sub:'Push · Pull alternating — Chest · Back · Shoulders',accent:'var(--accent)',
    moves:[DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_KBHALO,
      ...
      {id:'mon-row',name:'Bent-Over Row',slot:'Pull · Horizontal Pull',target:'Back · Biceps',equip:'Tube 30–40 → 50–70 lb',rx:'3–4×10–12',cal:35,cue:'Drive elbows into your back pockets — not hands to your chest',demo:'row',log:'setsreps',sets:4,
      ...
      {id:'mon-ohp',name:'Overhead Press',slot:'Push · Vertical Push',target:'Shoulders',equip:'Tube 20–30 → 40–50 lb',rx:'3×10–12',cal:35,cue:"Press straight to the ceiling — don't let your low back arch",demo:'press',log:'setsreps',sets:3,
  ...
  wed:{title:'Wednesday Yoga Flow',sub:'Full-body mobility · no bands · Charlie Follows + Moves',accent:'var(--purple)',
    moves:[
      ...
      {id:'wed-fin-carry',name:'Loaded Carry',slot:'Finisher · Full Body',target:'Core · Grip · Forearms',equip:'2× 10 lb dumbbells or 8 lb kettlebell',rx:'3×30–40s walk',cal:20,demo:'walk',log:'time',secs:30,sets:3,cue:'Stand tall, core braced, shoulders down — walk a short controlled lap, resist any side-lean',
        setup:'Hold a weight in each hand (or one kettlebell suitcase-style at your side) and walk a short, controlled lap — down a hallway and back, or in place if space is tight. Keep your ribcage stacked over your hips and resist leaning toward either side; that anti-lateral-flexion demand is what makes carries such good core work. No spinal loading pattern here, just grip, bracing, and posture under tension — a good fit given the SI joint history since there\'s no hinge or rotation involved.',
  ...
  thu:{title:'Upper Body B',sub:'Push · Pull alternating — Chest · Back · Arms',accent:'var(--accent)',
    moves:[DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_KBHALO,
      ...
      {id:'thu-lat',name:'Lats / Pulldown',slot:'Pull · Vertical Pull',target:'Lats · Back',equip:'Tube 20–30 → 50 lb',rx:'3–4×10–12',cal:35,cue:'Drive elbows into your back pockets — chest up, slight lean back',demo:'pulldown',log:'setsreps',sets:4,
        variants:[{name:'Wide Row (free)',equip:'Tube 20–30 lb',rx:'3×12',cue:'Pull wide to the ribs, squeeze the mid-back',demo:'row'},
