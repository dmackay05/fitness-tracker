...
var DS_SESSIONS={
  ...
  thu:{title:'Upper Body B',sub:'Push · Pull alternating — Chest · Back · Arms',accent:'var(--accent)',
    moves:[DS_WARMUP_RAISE,DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_BANDSHOULDER,DS_WARMUP_SHOULDERCARS,
      ...
      {id:'thu-lateral',name:'Lateral Raise',demo:'lateralraise',slot:'Push · Side Delts',target:'Side Delts',equip:'Tube 10 → 30 lb',rx:'5×12–15',cal:25,cue:'Lead with elbows, not hands — pour water from a pitcher',log:'setsreps',sets:5,
        variants:[{name:'Front-Angled Lateral Raise',equip:'Tube 10 lb · anchored low in front of you',rx:'3×12–15',cue:'Stand on the band so it pulls slightly from in front rather than straight down — this loads the side delt earlier, right at the stretched bottom position',demo:'lateralraise'},{name:'Incline Ball Lateral Raise',equip:'Ball + 2× 10 lb dumbbells (or 2 lb to start)',rx:'3×12–15',cue:'Lie chest-down on the ball at an incline, feet braced on the floor behind you — raise both DBs out to your sides leading with the elbows, control the lower for a deep stretch at the bottom. The ball locks your torso still so the delt does all the work instead of momentum.',demo:'lateralraise'}]},
      {id:'thu-uprightrow',name:'Banded Upright Row',slot:'Pull · Traps',target:'Traps · Side Delts',equip:'Tube 20–30 lb, stand on band',rx:'4×10–12',cal:25,cue:'Stand on the band, pull the handles straight up along your body to chest height, elbows leading and staying above wrists — stop if the shoulders complain, this can be a cranky-shoulder movement for some people.',demo:'row',log:'setsreps',sets:4},
      {id:'thu-shrug',name:'Banded Shrug',slot:'Pull · Traps',target:'Traps (upper)',equip:'Tube 20–30 lb · stand on band',rx:'4×15–20',cal:20,cue:'Straight up and down, no rolling — pause 1 sec at the top, control the lower',demo:'trap3',log:'setsreps',sets:4,
  ...
  fri:{title:'Lower Body Pull',sub:'Hamstrings · Glutes · Lower Back',accent:'var(--accent)',
    moves:[DS_WARMUP_RAISE,DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW7,DS_WARMUP_HIPCARS,
      ...
      {id:'fri-nordic',name:'Stability Ball Leg Curl',slot:'Knee Flexion',target:'Hamstrings',equip:'Stability ball',rx:'4×10–12',cal:30,cue:'Hips stay up the whole set — curl the ball in, roll out over a slow 3-count',demo:'ballcurl',log:'setsreps',sets:4,variants:[{name:'Single-Leg Ball Curl',equip:'Stability ball',rx:'3×6–8/leg',cue:'One heel on the ball — hips level, slow 3-count roll-out',demo:'ballcurl'}]},
