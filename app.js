...
var DS_PULLUP={key:"pullup",title:"Pull-Up Progression",accent:"#7dd3fc",meta:"toward your first rep \u00b7 alternating days",blurb:"Your road to the first unassisted pull-up \u2014 a 10-stage ladder from Dead Hang to strict Bodyweight Pull-ups. Log each drill so the numbers climb \u2014 that climb is the progress. Hit the milestone rep/hold target for 3 sets before advancing to the next stage. Take the hardest drill close to failure; ease off if the elbow flares.",moves:[
 ...
 {id:"pu-band",name:"7. Band-Assisted Pull-ups",rx:"3\u00d76\u20138",cal:15,demo:"pullband",log:"setsreps",sets:3,target:"Full pulling chain",equip:"Tube band over the bar (medium band)",cue:"Elbows drive down and back, chest toward the bar \u2014 twist the bar like you're breaking a twig (down and in) so the lats fire first, not the biceps",setup:"Loop a medium band over the bar, foot or knee in it. Do full pull-ups, logging reps and which band in the weight box. Don't just haul straight up \u2014 pull down and slightly inward from the very first inch, like snapping a wooden twig rather than an iron bar. Milestone: 6\u20138 reps with a medium band \u00d7 3 sets, then move to Band-Assisted Top Hold."},
 {id:"pu-bandtop",name:"8. Band-Assisted Top Hold",rx:"3\u00d710s hold",cal:15,demo:"pullband",log:"setsreps",sets:3,target:"Full pulling chain \u00b7 Isometric Strength",equip:"Tube band over the bar (medium band)",cue:"Pull to the top with band assist, then hold your chin over the bar as long as you can before lowering",setup:"Same band setup as Band-Assisted Pull-ups \u2014 pull to the top and hold the chin-over-bar position isometrically instead of doing continuous reps. Milestone: 10-second hold with a medium band \u00d7 3 sets, then move to Negatives."},
