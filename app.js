...
var DS_SESSIONS={
  ...
  fri:{title:'Lower Body Pull',sub:'Hamstrings · Glutes · Lower Back',accent:'var(--accent)',
    moves:[DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW7,
      ...
      {id:'fri-slrdl',name:'Romanian Deadlift (Bilateral)',slot:'Hinge',target:'Hamstrings',equip:'Tube 40–50 lb',rx:'3–4×8–12',cal:35,cue:'Stand on the tube, soft knees, push hips straight back — flat back, handles tracing down the thighs to a deep stretch, drive hips forward to finish. Now your primary Friday hinge — stack bands and push to true failure the same way you\'re doing with rows/curls/pulldown.',demo:'hinge',log:'setsreps',sets:4,ramp:'1 set light band × 10, 1 set one step below working band × 6–8, then working sets.',
        ...
        setup:'Stand on the center of the band with both feet, soft bend in the knees. Push your hips straight back, letting the handles trace down the front of your thighs with a flat back, until you feel a deep hamstring stretch, then drive the hips forward to stand tall. Same movement as Tuesday\'s RDL — this is the second weekly hamstring hinge, so keep it in the working-load rotation rather than defaulting back to the light dumbbell version.'},
