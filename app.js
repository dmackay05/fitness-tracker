...
var DS_SESSIONS={
  ...
  thu:{title:'Upper Body B',sub:'Push · Pull alternating — Chest · Back · Arms',accent:'var(--accent)',
    moves:[DS_WARMUP_RAISE,DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_BANDSHOULDER,
      {id:'mon-inclinepress',name:'Incline Close-Grip Press',slot:'Push · Chest',target:'Chest · Triceps · Front Delts',equip:'Tube 20–30 lb · low anchor',rx:'3×10–12',cal:30,cue:'Anchor low behind you, hands closer together than shoulder-width, elbows tucked in (not flared) — press up and out at an incline angle, squeeze the upper chest at the top. The narrow grip pulls real triceps work into a chest day on top of the upper chest/front delts — more muscle recruited per set than a wide-grip incline press.',demo:'press',log:'setsreps',sets:3,variants:[{name:'Standard-Grip Incline Press',equip:'Tube 20–30 lb · low anchor',rx:'3×10–12',cue:'Shoulder-width or slightly wider grip — same incline angle, shifts emphasis back toward pure chest with less triceps involvement',demo:'press'},{name:'Ball DB Chest Press',equip:'Ball + 2\u00d7 10 lb DBs',rx:'3\u00d712\u201315',cue:'Upper back on the ball, hips bridged up in line with your shoulders and knees (like a supported bench) \u2014 press both DBs straight up over your chest, lower until elbows are just below the ball line for a deep stretch, press back up. Keep hips locked \u2014 don\u2019t let them drop as you fatigue.',demo:'press'}]},
