...
var DS_SESSIONS={
  mon:{title:'Upper Body A',sub:'Push · Pull alternating — Chest · Back · Shoulders',accent:'var(--accent)',
    moves:[DS_WARMUP_RAISE,DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_BANDSHOULDER,
      ...
      {id:'mon-row',name:'Bent-Over Row',slot:'Pull · Horizontal Pull',target:'Back · Biceps',equip:'Tube 30–40 → 50–70 lb',rx:'3–4×10–12',cal:35,cue:'Drive elbows into your back pockets — not hands to your chest',demo:'row',log:'setsreps',sets:4,ramp:'1 set light band × 10, 1 set one step below working band × 6–8, then your working sets.',
  ...
  tue:{title:'Lower Body Push',sub:'Quads · Glutes · Core',accent:'var(--accent)',
    moves:[DS_WARMUP_RAISE,DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW7,
  ...
  thu:{title:'Upper Body B',sub:'Push · Pull alternating — Chest · Back · Arms',accent:'var(--accent)',
    moves:[DS_WARMUP_RAISE,DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_BANDSHOULDER,
      ...
      {id:'thu-lat',name:'Underhand Pulldown',slot:'Pull · Vertical Pull',target:'Lats · Biceps · Forearms',equip:'Tube 20–30 → 50 lb',rx:'3–4×10–12',cal:35,cue:'Underhand (palms-up) grip — drive elbows down and into your back pockets, chest up, slight lean back. The underhand grip pulls real biceps/forearm work into a back day, on top of the lats — more muscle recruited per set than the standard overhand pulldown.',demo:'pulldown',log:'setsreps',sets:4,ramp:'1 set light band × 10, 1 set one step below working band × 6–8, then working sets.',
      ...
      {id:'thu-lateral',name:'Lateral Raise',demo:'lateralraise',slot:'Push · Side Delts',target:'Side Delts',equip:'Tube 10 → 30 lb',rx:'3×12–15',cal:25,cue:'Lead with elbows, not hands — pour water from a pitcher',log:'setsreps',sets:3,
