...
var DS_SESSIONS={
  mon:{title:'Upper Body A',sub:'Push · Pull alternating — Chest · Back · Shoulders',accent:'var(--accent)',
    moves:[DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_KBHALO,
      ...
      {id:'mon-tri',name:'Triceps Pushdown',slot:'Push · Triceps',target:'Triceps',equip:'Tube 10–20 → 30 lb',rx:'3×12–15',cal:25,cue:'Elbows pinned to ribs — only forearms move',log:'setsreps',sets:3,
  ...
  tue:{title:'Lower Body Push',sub:'Quads · Glutes · Core',accent:'var(--accent)',
    moves:[DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW7,
      ...
      {id:'tue-step',name:'Step-Up',demo:'stepup',slot:'Unilateral',target:'Quads · Balance',equip:'Chair or step',rx:'3×10/side',cal:30,cue:"Drive through the front heel only — don't push off the back foot",log:'setsreps',sets:3,variants:[{name:'Step-Down',equip:'Chair or step, bodyweight',rx:'3×10/side',cue:'Stand on the step, lower the free foot slowly to tap the floor and drive back up — the controlled lowering (eccentric) is the work, less balance-demanding than a step-up',demo:'stepup'}]},
      ...
      {id:'wed-slam',name:'Ball Slam',demo:'slam',slot:'Power (bonus)',target:'Full Body',equip:'10 lb slam ball',rx:'3×10',cal:35,cue:'Full reach overhead first — drive the ball through the floor. Moved from Wednesday — pairs with Jump Squat as a second power move',log:'setsreps',sets:3,
      ...
      {id:'wed-fin-wallsit',name:'Wall Sit',slot:'Finisher · Quads (isometric)',target:'Quads',equip:'Bodyweight + wall',rx:'2×30–45s',cal:12,cue:'Back flat against the wall, knees near 90° — no spinal loading, just hold and breathe. Moved from Wednesday',demo:'squat',log:'time',secs:30,
        setup:'Slide your back down a wall until your knees are bent to roughly 90 degrees, thighs close to parallel with the floor. Hold, keeping your back flat against the wall and breathing steadily. Zero impact and zero spinal load — good finisher after the heavier squat work above.',
  ...
  thu:{title:'Upper Body B',sub:'Push · Pull alternating — Chest · Back · Arms',accent:'var(--accent)',
    moves:[DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_KBHALO,
      {id:'mon-inclinepress',name:'Banded Incline Press',slot:'Push · Chest',target:'Chest · Upper Chest',equip:'Tube 20–30 lb · low anchor',rx:'3×10–12',cal:30,cue:'Anchor low behind you, press up and out at an incline angle — squeeze the upper chest at the top',demo:'press',log:'setsreps',sets:3,variants:[{name:'Ball DB Chest Press',equip:'Ball + 2\u00d7 10 lb DBs',rx:'3\u00d712\u201315',cue:'Upper back on the ball, hips bridged up in line with your shoulders and knees (like a supported bench) \u2014 press both DBs straight up over your chest, lower until elbows are just below the ball line for a deep stretch, press back up. Keep hips locked \u2014 don\u2019t let them drop as you fatigue.',demo:'press'}]},
      {id:'thu-lat',name:'Lats / Pulldown',slot:'Pull · Vertical Pull',target:'Lats · Back',equip:'Tube 20–30 → 50 lb',rx:'3–4×10–12',cal:35,cue:'Drive elbows into your back pockets — chest up, slight lean back',demo:'pulldown',log:'setsreps',sets:4,ramp:'1 set light band × 10, 1 set one step below working band × 6–8, then working sets.',
        variants:[{name:'Wide Row (free)',equip:'Tube 20–30 lb',rx:'3×12',cue:'Pull wide to the ribs, squeeze the mid-back',demo:'row'},
      ...
      {id:'mon-standbandpress',name:'Standing Band Chest Press',slot:'Push · Horizontal Push',target:'Chest',equip:'Tube band anchored behind back',rx:'3×12–15',cal:30,cue:'Band anchored around your back, thumbs looped through the handles — press straight out in front of you and squeeze the chest hard at full extension, then control the return',demo:'press',log:'setsreps',sets:3,variants:[{name:'Ball DB Chest Press',equip:'Ball + 2× 10 lb DBs',rx:'3×12–15',cue:'Upper back on the ball, hips bridged level with shoulders and knees — press both DBs up over the chest, lower to a deep stretch just below the ball line, press back up. Keep hips locked, no sagging as you fatigue',demo:'press'}]},
      {id:'mon-pullapart',name:'Band Pull-Apart',slot:'Pull · Rear Delts',target:'Rear Delts',equip:'Tube 10–20 lb',rx:'3×15–20',cal:25,cue:'Crack a walnut between your shoulder blades — arms stay straight',demo:'fly',log:'setsreps',sets:3,variants:[{name:'Cross-Body Rear Delt Fly',equip:'Tube 10–20 lb · chest-height anchor',rx:'3×12–15',cue:'Anchor at chest height, reach the working arm all the way across your body toward the anchor for a deep pre-stretch, then sweep it out and back — rear delt only, no shrugging',demo:'fly'}]},
      {id:'thu-lateral',name:'Lateral Raise',demo:'lateralraise',slot:'Push · Side Delts',target:'Side Delts',equip:'Tube 10 → 20 lb',rx:'3×12–15',cal:25,cue:'Lead with elbows, not hands — pour water from a pitcher',log:'setsreps',sets:3,
      ...
      {id:'wed-tgu',name:'Turkish Get-Up',slot:'Full Body · Shoulder Stability',target:'Core · Shoulder Stability',equip:'8 lb kettlebell',rx:'2×3/side',cal:30,cue:'Eye stays on the weight the whole time — slow, one step at a time. Moved from Wednesday — nothing else in the program hits loaded shoulder stability like this',demo:'tgu',log:'setsreps',sets:2,
      ...
      {id:'wed-fin-carry',name:'Loaded Carry',slot:'Finisher · Full Body',target:'Core · Grip · Forearms',equip:'2× 10 lb dumbbells or 8 lb kettlebell',rx:'3×30–40s walk',cal:20,demo:'walk',log:'time',secs:30,sets:3,cue:'Stand tall, core braced, shoulders down — walk a short controlled lap, resist any side-lean. Moved from Wednesday',
        setup:'Hold a weight in each hand (or one kettlebell suitcase-style at your side) and walk a short, controlled lap. Keep your ribcage stacked over your hips and resist leaning toward either side — that anti-lateral-flexion demand is what makes carries good core work, and there\'s no hinge or rotation to worry the SI joint.',
        variants:[{name:'Single-Side Suitcase Carry',equip:'1× 10 lb dumbbell or 8 lb kettlebell',rx:'3×20–30s/side',cue:'Same walk, weight on one side only — the anti-lean demand doubles since there\'s no counterbalance from the other hand. Switch sides each set.',demo:'walk'}]}]},
  ...
  fri:{title:'Lower Body Pull',sub:'Hamstrings · Glutes · Lower Back',accent:'var(--accent)',
    moves:[DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW7,
      ...
      {id:'tue-rdl',name:'Romanian Deadlift',slot:'Hinge',target:'Hamstrings',equip:'Tube 40–50 → 90+ lb',rx:'3–4×10–12',cal:35,cue:'Push hips back to the wall — handles glued to your legs',demo:'hinge',log:'setsreps',sets:4,ramp:'1 set light band × 10, 1 set one step below working band × 6–8, then working sets. Extra important here since spinal loading goes up with the heavier bands.',
        variants:[{name:'Single-Leg DB RDL',equip:'10 lb dumbbell (opposite hand)',rx:'3×10–12/leg',cue:'Hinge forward, DB toward the floor as the free leg extends behind you — hips stay square',demo:'slrdl'},
                  {name:'Super Band RDL',equip:'Clench 35–75 lb band underfoot',rx:'3–4×8–10',cue:'Stand on the band, hinge back — tension peaks at lockout, squeeze the glutes hard at the top',demo:'hinge'}]},
      {id:'tue-bridge',name:'Banded Glute Bridge',slot:'Glutes',target:'Glutes',equip:'Tube 30–40 → 50+ lb',rx:'3×15–20',cal:30,cue:'Drive through heels, squeeze hard at the top — hold 2 sec',demo:'bridge',log:'setsreps',sets:3,
        variants:[{name:'Banded Hip Thrust',equip:'Shoulders on couch + tube band over hips',rx:'3×12–15',cue:'Upper back on the couch edge — hips sink below the seat, then drive to a flat tabletop and squeeze 2 sec',demo:'hipthrust'},{name:'Feet-on-Ball Glute Bridge',equip:'Stability ball',rx:'3\u00d712',cue:'Heels on the ball, bridge up and hold the ball dead still \u2014 glutes and hamstrings work double',demo:'bridge'},
                  {name:'Heavy Band Hip Thrust',equip:'Clench 35–75 lb band over hips',rx:'3×10–12',cue:'Shoulders on the couch, band looped over the hips and anchored under both feet — drive up to a flat tabletop against real resistance, squeeze 2 sec at the top',demo:'hipthrust',setup:'Anchor the band under both feet, upper back on the edge of the couch, band looped over your hip crease (pad it with a towel if it digs in). Drive through the heels to a flat tabletop position, squeezing the glutes hard at the top, then lower under control. This is the loaded progression once bodyweight hip thrusts feel easy — heaviest posterior-chain option in the lineup.'}]},
      ...
      {id:'fri-goodmorning',name:'Banded Good Morning',slot:'Hip Hinge · Posterior Chain',target:'Hamstrings · Glutes · Lower Back',equip:'Tube 30–40 lb → Clench 35–75 lb band',rx:'3×12–15',cal:35,demo:'hinge',cue:'Hips back, flat back — squeeze glutes hard to stand up. With the heavier Clench band, go easy at first — more load through the spine means the SI joint gets more say in how deep you go.',log:'setsreps',sets:3,
      ...
      {id:'fri-kbswing',name:'Kettlebell Swing',slot:'Hip Hinge · Power',target:'Glutes · Hamstrings · Core',equip:'8 lb kettlebell',rx:'3×10–12',cal:30,demo:'hinge',cue:'⚠️ SI joint caution — start very light, hips snap back and forward, arms are just along for the ride. Trial this on a week separate from Good Morning so you know which one is responsible if anything flares up.',log:'setsreps',sets:3,
        setup:'Stand with feet shoulder-width apart, kettlebell on the floor a foot in front of you. Hinge down and grip it with both hands, then drive your hips forward explosively to swing it up to chest height — power comes entirely from the hip snap, not the arms or shoulders. Let it swing back down between your legs and immediately hinge into the next rep. This is more explosive than your other hinge work, so it puts more force through the SI joint than the RDL or Good Morning — start with a handful of reps and stop the moment anything feels off, well before the prescribed 10–12.',
        mistakes:['Squatting instead of hinging — knees barely bend, this is a hip-back movement.','Using the arms to lift the weight — arms are a rope, hips are the engine.','Going too heavy or too many reps too soon — this is new to the program, build up slowly.']},
...
var DS_MV={
  ...
  'wed-fin-carry':{'Core':1,'Forearms':1,'Back':.5},
