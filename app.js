...
var DS_SESSIONS={
  mon:{title:'Upper Body A',sub:'Push · Pull alternating — Chest · Back · Shoulders',accent:'var(--accent)',
    moves:[DS_WARMUP_RAISE,DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_BANDSHOULDER,DS_WARMUP_SHOULDERCARS,
      ...
      {id:'thu-facepull',name:'Rear Delts / Face Pull',slot:'Pull · Rear Delts',target:'Rear Delts · Traps',equip:'Tube 10–20 → 50 lb',rx:'5×15–20',cal:30,cue:'Pull to your temples, elbows high — thumbs point behind you at the finish',demo:'facepull',log:'setsreps',sets:5,
  ...
  thu:{title:'Upper Body B',sub:'Push · Pull alternating — Chest · Back · Arms',accent:'var(--accent)',
    moves:[DS_WARMUP_RAISE,DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_BANDSHOULDER,DS_WARMUP_SHOULDERCARS,
      {id:'mon-inclinepress',name:'Incline Close-Grip Press',slot:'Push · Chest',target:'Chest · Triceps · Front Delts',equip:'Tube 20–30 → 50 lb, anchored to a door below chest height',rx:'3×10–12',cal:30,cue:'Anchor low on a door behind you, hands closer together than shoulder-width, elbows tucked in (not flared) — press up and out at an incline angle, squeeze the upper chest at the top. The narrow grip pulls real triceps work into a chest day on top of the upper chest/front delts — more muscle recruited per set than a wide-grip incline press.',demo:'press',log:'setsreps',sets:3,variants:[{name:'Standard-Grip Incline Press',equip:'Tube 20–30 → 50 lb, anchored to a door below chest height',rx:'3×10–12',cue:'Shoulder-width or slightly wider grip — same incline angle, shifts emphasis back toward pure chest with less triceps involvement',demo:'press'},{name:'Behind-Back Anchor Incline Press',equip:'Tube 20–30 → 50 lb, anchored low behind you',rx:'3×10–12',cue:'Same close-grip incline press, band anchored around your back instead of a door — keeps even tension through the whole range since the anchor moves with you',demo:'press'},{name:'Ball DB Chest Press',equip:'Ball + 2\u00d7 10 lb DBs',rx:'3\u00d712\u201315',cue:'Upper back on the ball, hips bridged up in line with your shoulders and knees (like a supported bench) \u2014 press both DBs straight up over your chest, lower until elbows are just below the ball line for a deep stretch, press back up. Keep hips locked \u2014 don\u2019t let them drop as you fatigue.',demo:'press'}]},
      ...
      {id:'mon-standbandpress',name:'Standing Band Chest Press',slot:'Push · Horizontal Push',target:'Chest',equip:'Tube 20–30 → 75 lb (Clench band), anchored to a door at chest height',rx:'3×12–15',cal:30,cue:'Anchor the band to a door at chest height, face away and step forward so there\'s already tension at the start (not slack) — press straight out in front of you and squeeze the chest hard at full extension, then control the return. Split stance (one foot forward) helps stability against the door anchor.',demo:'press',log:'setsreps',sets:3,variants:[{name:'Behind-Back Anchor Press',equip:'Tube 20–30 → 75 lb (Clench band) anchored behind back',rx:'3×12–15',cue:'Band anchored around your back instead of a door, thumbs looped through the handles — same press-and-squeeze pattern, keeps even tension through the whole range since the anchor moves with you',demo:'press'},{name:'Ball DB Chest Press',equip:'Ball + 2× 10 lb DBs',rx:'3×12–15',cue:'Upper back on the ball, hips bridged level with shoulders and knees — press both DBs up over the chest, lower to a deep stretch just below the ball line, press back up. Keep hips locked, no sagging as you fatigue',demo:'press'}]},
      {id:'mon-pullapart',name:'Band Pull-Apart',slot:'Pull · Rear Delts',target:'Rear Delts',equip:'Tube 10–20 → 50 lb',rx:'5×15–20',cal:25,cue:'Crack a walnut between your shoulder blades — arms stay straight',demo:'fly',log:'setsreps',sets:5,variants:[{name:'Cross-Body Rear Delt Fly',equip:'Tube 10–20 lb · chest-height anchor',rx:'3×12–15/side',cue:'Anchor at chest height, reach the working arm all the way across your body toward the anchor for a deep pre-stretch, then sweep it out and back — rear delt only, no shrugging',demo:'fly'}]},
      {id:'thu-lateral',name:'Lateral Raise',demo:'lateralraise',slot:'Push · Side Delts',target:'Side Delts',equip:'Tube 10 → 30 lb',rx:'5×12–15',cal:25,cue:'Lead with elbows, not hands — pour water from a pitcher',log:'setsreps',sets:5,
        variants:[{name:'Front-Angled Lateral Raise',equip:'Tube 10 lb · anchored low in front of you',rx:'3×12–15',cue:'Stand on the band so it pulls slightly from in front rather than straight down — this loads the side delt earlier, right at the stretched bottom position',demo:'lateralraise'},{name:'Incline Ball Lateral Raise',equip:'Ball + 2× 10 lb dumbbells (or 2 lb to start)',rx:'3×12–15',cue:'Lie chest-down on the ball at an incline, feet braced on the floor behind you — raise both DBs out to your sides leading with the elbows, control the lower for a deep stretch at the bottom. The ball locks your torso still so the delt does all the work instead of momentum.',demo:'lateralraise'}]},
...
function dsShowExerciseHistory(id){
  try{ dsToast('Loading progress\u2026'); }catch(e0){}
  ...
  if(title) title.textContent = name+" \u2014 Progress";
  try{
    ta.value = dsBuildExerciseHistoryText(id);
  }catch(e){
    ta.value = name+"\n\nCouldn't load history ("+((e&&e.message)||e)+"). Tap the thumbs-down / let David know if this keeps happening.";
  }
