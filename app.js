...
var DS_SESSIONS={
  mon:{title:'Upper Body Push + Pull',sub:'Chest · Shoulders · Back · Arms',accent:'var(--accent)',
    moves:[DS_WARMUP_ARMCIRCLE,DS_WARMUP_HIPFLOW9,DS_WARMUP_KBHALO,
      ...
      {id:'mon-inclinepress',name:'Banded Incline Press',slot:'Chest',target:'Chest · Upper Chest',equip:'Tube 20–30 lb · low anchor',rx:'3×10–12',cal:30,cue:'Anchor low behind you, press up and out at an incline angle — squeeze the upper chest at the top',demo:'press',log:'setsreps',sets:3},
